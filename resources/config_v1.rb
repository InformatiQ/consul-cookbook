...
property :acl_enforce_version_8, equal_to: [true, false]
...
property :atlas_join, equal_to: [true, false]
...
property :bootstrap, equal_to: [true, false]
...
property :disable_anonymous_signature, equal_to: [true, false]
property :disable_host_node_id, equal_to: [true, false]
property :disable_keyring_file, equal_to: [true, false]
property :disable_remote_exec, equal_to: [true, false]
property :disable_update_check, equal_to: [true, false]
property :discard_check_output, equal_to: [true, false]
property :discovery_max_stale, kind_of: String
property :dns_config, kind_of: [Hash, Mash]
property :domain, kind_of: String
property :enable_acl_replication, equal_to: [true, false]
property :enable_additional_node_meta_txt, equal_to: [true, false]
property :enable_agent_tls_for_checks, equal_to: [true, false]
property :enable_central_service_config, equal_to: [true, false]
property :enable_debug, equal_to: [true, false]
property :enable_local_script_checks, equal_to: [true, false]
property :enable_script_checks, equal_to: [true, false]
property :enable_syslog, equal_to: [true, false]
...
property :non_voting_server, equal_to: [true, false]
...
property :rejoin_after_leave, equal_to: [true, false]
...
property :server, equal_to: [true, false]
property :server_name, kind_of: String
property :session_ttl_min, kind_of: String
property :skip_leave_on_interrupt, equal_to: [true, false]
...
property :verify_incoming_rpc, equal_to: [true, false]
property :verify_outgoing, equal_to: [true, false]
property :verify_server_hostname, equal_to: [true, false]
